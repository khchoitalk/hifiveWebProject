 ...
 * Generated at: 2018-09-15 15:45:35 UTC
...
public final class tutorial_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/support/../../supportmenu.jsp", Long.valueOf(1535623716000L));
    _jspx_dependants.put("/views/support/../../information.jsp", Long.valueOf(1535623792000L));
    _jspx_dependants.put("/views/support/../.././views/support/accessTerms.jsp", Long.valueOf(1535623716000L));
    _jspx_dependants.put("/views/support/../../header.jsp", Long.valueOf(1535623792000L));
    _jspx_dependants.put("/views/support/../../footer.jsp", Long.valueOf(1535623718000L));
    _jspx_dependants.put("/views/support/../.././views/support/policy.jsp", Long.valueOf(1535623716000L));
  }
...
if(infoUser.getAddress() != null) { 
 ...
 if(infoUser.getSafety_check().toUpperCase().equals("N")) { 
   ...
   String userid = (String)session.getAttribute("userId");
      ...
      out.write("\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t<div class=\"card\" style=\"width: 600px;\" id=\"tutorialcard\">\r\n");
      out.write("\t\t\t\t\t<div class=\"card-body\">\r\n");
      out.write("\t\t\t\t\t\t<h3 class=\"card-title\">\r\n");
      out.write("\t\t\t\t\t\t\t<font style=\"color: #ff6633\"><b>Traveler's Couch 이용 방법</b></font>\r\n");
      out.write("\t\t\t\t\t\t</h3>\r\n");
      out.write("\t\t\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t\t\t<p class=\"card-text\">\r\n");
      out.write("\t\t\t\t\t\t\t<font style=\"color: black; font-size: 13pt\"><b>다양한 사람과\r\n");
      out.write("\t\t\t\t\t\t\t\t\t문화를 만나고, 새로운 친구를 만드십시오.</b></font><br>\r\n");
      out.write("\t\t\t\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t\t\t\t<br> <font style=\"color: black; font-size: 10pt\"> <b>Traveler's\r\n");
      out.write("\t\t\t\t\t\t\t\t\tCouch</b>은 여행자들을 커뮤니티에 연결시키는 서비스입니다.<br> <b>Traveler's\r\n");
      out.write("\t\t\t\t\t\t\t\t\tCouch</b>을 사용하여 집이나 고향을 여행자들과 공유하거나 공유 할 장소를 <br>찾으십시오.<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t<b>Traveler's Couch</b>는 항상해야 할 일이 있고 만날 새로운 친구가 있도록 도와줍니다\r\n");
      out.write("\t\t\t\t\t\t\t</font><br>\r\n");
      out.write("\t\t\t\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t\t\t\t<br> <font style=\"color: #ff6633; font-size: 15pt\"><b>1. 안전\r\n");
      out.write("\t\t\t\t\t\t\t\t\t기본 사항에 대해 읽기</b></font><br>\r\n");
      out.write("\t\t\t\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t\t\t\t<!-- <font style = \"color:black; font-size: 10pt\"> -->\r\n");
      out.write("\t\t\t\t\t\t\t사이트에서 제공하는 안전 기본 사항을 읽고 체크하십시오.<br>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"card border-0\">\r\n");
      out.write("\t\t\t\t\t\t\t<center>\r\n");
      out.write("\t\t\t\t\t\t\t\t<img class=\"card-img-top\" style=\"width: 200px; height: 250px;\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tsrc=\"/hifive/resources/image/safty1.jpg\" alt=\"Card image cap\">\r\n");
      out.write("\t\t\t\t\t\t\t</center>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"card-body\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<font style=\"color: black; font-size: 10pt\"><p\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"card-text\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t다른사람들과 커뮤니케이션 전 유의해야 될점에 <br>대해 명확하게 알려주고 있습니다. <br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t당신은 안전 기본 사항을 읽지 않고 사이트를 제대로 이용할 수 없습니다. <br> <b>문제가\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t발생하지 않도록 꼭 읽고 확인하십시오.</b>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</p></font>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<!-- </font> -->\r\n");
      out.write("\t\t\t\t\t\t<br> <font style=\"color: #ff6633; font-size: 15pt\"><b>2. 프로필\r\n");
      out.write("\t\t\t\t\t\t\t\t만들기</b></font><br>\r\n");
      out.write("\t\t\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"card border-0\">\r\n");
      out.write("\t\t\t\t\t\t\t<center>\r\n");
      out.write("\t\t\t\t\t\t\t\t<img class=\"card-img-top\" style=\"width: 400px; height: 400px;\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tsrc=\"/hifive/resources/image/profile1.png\" alt=\"Card image cap\">\r\n");
      out.write("\t\t\t\t\t\t\t</center>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"card-body\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<font style=\"color: black; font-size: 10pt\"><p\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"card-text\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t첫 번째 단계 <b>Traveler's Couch</b> 프로필을 완벽하게 작성하십시오! <br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t이것은 당신을 소개할 수 있는 최초의 수단이 될 것이며,<br> 자신을 알려줄 수 있는 최초의\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t방법입니다 <br> 세세한 프로필을 보유하는 것이 다른 사람들과 연결하는 가장 좋은 방법입니다.<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t작성된 프로필로 다른 사람에게 신뢰감을 심어주십시오.\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</p></font>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t\t\t<font style=\"color: #ff6633; font-size: 15pt\"><b>3-1. 친구\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t찾기</b></font><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t<br> <font style=\"color: black; font-size: 10pt\"><p\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"card-text\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t완벽한 프로필을 작성했다면, 가고 싶은 지역에 호스트,파트너,서퍼를 검색해보십오.<br> 대화를\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t나누고싶은 상대의 프로필을 세세하게 확인해보십시오.<br> 대상의 프로필에는 대상이 원하는 날짜,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t대상의 평가지침이 될 수 있는 리뷰가 있습니다. 동료를 찾았다면, 사이트에서 제공하는 대화기능으로 대화를 나누어\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t보십시오.</font><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t<br> <font style=\"color: #ff6633; font-size: 15pt\"><b>3-2. 친구가\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t되어주기</b></font><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t<br> <font style=\"color: black; font-size: 10pt\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t당신은 다른사람에게 호스팅,파트너를 요청할 수도 있지만, 당신이 호스터 또는 <br>파트너로서 서퍼를\r\n");
      out.write("\t\t\t\t\t\t\t\t\t초대할 수도 있습니다.<br> 등록되어 있는 서퍼를 초대하고 그들과 대화를 나누어보십시오.<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t이는 당신에게도, 상대방에게도 <b>멋진 경험을 선물</b>해 줄 것입니다.\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t</font>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<div class=\"card border-0\">\r\n");
      out.write("\t\t\t\t\t\t\t<center>\r\n");
      out.write("\t\t\t\t\t\t\t\t<img class=\"card-img-top\" style=\"width: 400px; height: 100px;\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tsrc=\"/hifive/resources/image/last.png\" alt=\"Card image cap\">\r\n");
      out.write("\t\t\t\t\t\t\t</center>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t우리 팀에게 궁금한 점이 있다면 - trevelsfriend@gmail.com - 에 문의하십시오 <br>\r\n");
      out.write("\t\t\t\t\t\t\t</font>\r\n");
      out.write("\t\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
