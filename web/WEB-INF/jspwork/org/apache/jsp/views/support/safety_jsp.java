 ...
 * Generated at: 2018-08-30 10:47:49 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.views.support;
...
public final class safety_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/support/../../supportmenu.jsp", Long.valueOf(1535623715955L));
    _jspx_dependants.put("/views/support/../../information.jsp", Long.valueOf(1535623790383L));
    _jspx_dependants.put("/views/support/../.././views/support/accessTerms.jsp", Long.valueOf(1535623715969L));
    _jspx_dependants.put("/views/support/../../header.jsp", Long.valueOf(1535623790378L));
    _jspx_dependants.put("/views/support/../../footer.jsp", Long.valueOf(1535623716083L));
    _jspx_dependants.put("/views/support/../.././views/support/policy.jsp", Long.valueOf(1535623715984L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
   ...
   String safetyuserid = (String)session.getAttribute("userId");
      ...
      out.write("<title>Traveler's Couch</title>tle>\r\n");
      out.write(" \r\n");
      ...
      out.write("   \r\n");
      out.write("\r\n");
      out.write("function safetyUpdateForm() {\r\n");
      out.write("\tvar userid = $(\"#userid\").val();\r\n");
      out.write("\t\r\n");
      out.write("\tvar allData = { \"userid\" : userid };\r\n");
      out.write("\t\r\n");
      out.write("\tvar chk = document.safety.safetyCheck.checked;\r\n");
      out.write("\t\r\n");
      out.write("\tif(chk) {\r\n");
      out.write("\t\t$.ajax({\r\n");
      out.write("\t\t\turl :\"/hifive/safetycheck\",\r\n");
      out.write("\t\t\ttype : 'post',\r\n");
      out.write("\t\t\tdata : allData,\r\n");
      out.write("\t        success : function(data){\r\n");
      out.write("\t        \tif(data == '0'){\r\n");
      out.write("\t        \t\t alert(\"알수없는 오류 입니다. 관리자에게 문의하세요\"); \r\n");
      out.write("\t        \t} else {\r\n");
      out.write("\t        \t\t/* alert(\"안전유의사항 업데이트 성공\"); */\r\n");
      out.write("\t        \t\tlocation.href = \"/hifive/views/support/safety.jsp\";\r\n");
      out.write("\t        \t}\r\n");
      ...
      out.write("\tvar chk = document.safety.safetyCheck.checked;\r\n");
      out.write("\tif(!chk) {\r\n");
      out.write("\t\t$(\"#checklabel\").css(\"color\", \"red\").css('font-size', '11px').text('안전 기본 사항을 읽고 체크하십시오.')\r\n");
      out.write("\t\t/* $(\"#safetyCheck\").css(\"display\", \"none\"); */ \r\n");
...
if(infoUser.getAddress() != null) { 
 ...
 if(infoUser.getSafety_check().toUpperCase().equals("N")) { 
   ...
   String userid = (String)session.getAttribute("userId");
      ...
      out.write("\t\t\t<br>\r\n");
      out.write("\t\t\t\t<div class=\"card\" style=\"width: 600px;\" id=\"safetycard\">\r\n");
      out.write("\t\t\t\t\t<div class=\"card-body\">\r\n");
      out.write("\t\t\t\t\t\t<h3 class=\"card-title\"><font style = \"color:#ff6633\"><b>안전 기본 사항</b></font></h3>\r\n");
      out.write("\t\t\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t\t\t<p class=\"card-text\">\r\n");
      out.write("\t\t\t\t\t\t<font style = \"color:black; font-size: 15pt\"><b>귀하의 안전은 중요합니다.<br> 제공하는 안전 기본 사항을 꼭 읽고 참고하십시요.</b></font><br><br><br>\r\n");
      out.write("\t\t\t\t\t\t<font style = \"color:#ff6633; font-size: 15pt\"><b>조심스럽게 프로필 및 참조 검토</b></font><br><br><br>\r\n");
      out.write("\t\t\t\t\t\t<font style = \"color:black; font-size: 12pt\">\r\n");
      out.write("\t\t\t\t\t\t귀하는 신중하게 회원 프로필을 검토 할 수 있습니다. <br>\r\n");
      out.write("\t\t\t\t\t\t회원들의 프로필을 참고하여, 자세하게 적었는지, 다른사람들의 평가는 어떤지 확인하십시오.<br>\r\n");
      out.write("\t\t\t\t\t\t이용 가능한 모든 정보를 철저히 읽고 천천히 상대방을 물색하십시오. 상대가 마음에 들지 않는다면 다시 물색하십시오.\r\n");
      out.write("\t\t\t\t\t\t</font><br><br><br>\r\n");
      out.write("\t\t\t\t\t\t<font style = \"color:#ff6633; font-size: 15pt\"><b>충분한 대화</b></font><br><br>\r\n");
      out.write("\t\t\t\t\t\t<font style = \"color:black; font-size: 12pt\">\r\n");
      out.write("\t\t\t\t\t\t매칭이 되고 싶은 상대를 계속해서 찾으십시오.<br>\r\n");
      out.write("\t\t\t\t\t\t대화를 하는데 있어서 무례하게 보이는 것에 대해 걱정하거나,\r\n");
      out.write("\t\t\t\t\t\t너의 경계에 대해 분명히하고 그들에 대해 부끄러워하지 마십시오.<br>\t\t\t\t\t\t \r\n");
      out.write("\t\t\t\t\t\t충분한 대화를 나누어 상대가 필요한 사람인지, 안전한 사람인지 판단하십시오.\r\n");
      out.write("\t\t\t\t\t\t혼자 상대와 함께 지내는 것이 불편하다면, 가족이나 커플과 함께 지내는 것을 고려하십시오.\r\n");
      out.write("\t\t\t\t\t\t</font><br><br><br>\r\n");
      out.write("\t\t\t\t\t\t<font style = \"color:#ff6633; font-size: 15pt\"><b>백업 계획을 가지십시오</b></font><br><br>\r\n");
      out.write("\t\t\t\t\t\t<font style = \"color:black; font-size: 12pt\">\r\n");
      out.write("\t\t\t\t\t\t해당 숙소에 도착이 후 대체 할 곳이 있는지 확인하십시오. <br>\r\n");
      out.write("\t\t\t\t\t\t가장 가까운 호스텔 또는 호텔을 확인하거나. <br> 이동하기 전에 백업 호스트를 준비하십시오.<br>\r\n");
      out.write("\t\t\t\t\t\t가능하다면, 도착하기 전에 호스트의 이웃을 조사하십시오. \t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t</font><br><br><br>\r\n");
      out.write("\t\t\t\t\t\t<font style = \"color:#ff6633; font-size: 15pt\"><b>자신의 신상정보를 함부로 공개하지 마십시오.</b></font><br><br>\r\n");
      out.write("\t\t\t\t\t\t<font style = \"color:black; font-size: 12pt\">\r\n");
      out.write("\t\t\t\t\t\t새로운 사람에게  처음부터 전화 번호, 이메일를 알려주지 마십시오.<br>\r\n");
      out.write("\t\t\t\t\t\t대화를 나누고싶다면,사이트에서 제공하는 쪽지 또는 모바일앱을 이용하십시오.<br>\r\n");
      out.write("\t\t\t\t\t\t혹시 대화 중 상대방으로부터 위험이 감지되면 대화내용을 저장하시고 신고게시판을 이용하십시오.\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t</font><br><br><br>\r\n");
      out.write("\t\t\t\t\t\t<font style = \"color:#ff6633; font-size: 15pt\"><b>리뷰를 작성하고 신고게시판을 이용하십시오</b></font><br><br>\r\n");
      out.write("\t\t\t\t\t\t<font style = \"color:black; font-size: 12pt\">\r\n");
      out.write("\t\t\t\t\t\t우리 팀은 가능한 한 가장 안전하고 신뢰할 수있는 커뮤니티를 구축하는 것을 돕기 위해 일하고 있습니다.<br>\r\n");
      out.write("\t\t\t\t\t\t부정적인 유저가 있다면 그에 프로필에 리뷰를 남기십시오.<br>\r\n");
      out.write("\t\t\t\t\t\t이는 다른 사람들이 추후에 더욱 안전한 매칭을 할 수 있도록 도와줍니다.<br>\r\n");
      out.write("\t\t\t\t\t\tTraveler's Couch에 대한 안전 문제를보고하면 향후 Traveler's Couch 를 안전하게 유지할 수 있습니다.<br>\r\n");
      out.write("\t\t\t\t\t\t비밀리에 부정적인 경험이나 안전 문제를 신고 하십시오 .\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t</font><br><br><br>\r\n");
      out.write("\t\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t\t<p>\r\n");
      out.write("\t\t\t\t\t\t<font style = \"color:red; font-size: 10pt; opacity: 0.4;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t우리 팀에서 제공하는 안전 기본 사항을 읽고 하단에 체크와 버튼을 클릭하십시요 <br>\r\n");
      out.write("\t\t\t\t\t\t</font>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t\t<br>\r\n");
 ...
 if(headeruser.getSafety_check().equals("N")) { 
      out.write("\t\r\n");
      out.write("\t\t\t\t\t\t<form id=\"checksafety\" action=\"/hifive/safetycheck\" onsubmit=\"return CheckForm()\"method=\"get\"  name=\"safety\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group form-check\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"checkbox\" class=\"form-check-input\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tid=\"safetyCheck\" name=\"safetyCheck\" value=\"readSafety\"> \r\n");
      out.write("\t\t\t\t\t\t\t\t<label class=\"form-check-label\" id = \"checklabel\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tfor=\"safetyCheck\"><font style = \"color:red; font-size:9pt;\">안전 기본 사항을 숙지하셨습니까?</font></label>\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"hidden\" id= \"userid\" name=\"userid\" value=\"");
      out.print( headeruser.getUser_Id() );
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"submit\" class=\"btn btn-primary\" id=\"agreeBtn\" value=\"동의합니다\"AAAAAAAAAA onclick=\"safetyUpdateForm();\">\r\n");
      out.write("\t\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t\t");
 } else { 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group form-check\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<!-- <input type=\"checkbox\" class=\"form-check-input\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tid=\"safetyCheck\" name=\"safetyCheck\" value=\"readSafety\" checked disabled>  -->\r\n");
      out.write("\t\t\t\t\t\t\t\t<label class=\"form-check-label\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tfor=\"safetyCheck\"><font style = \"color:blue; font-size:9pt;\">귀하는 이미 체크 하셨습니다.</font></label>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<input type=\"submit\" class=\"btn btn-primary\" id=\"agreeBtn\" disabled value=\"동의합니다\">\r\n");
      out.write("\t\t\t\t\t");
 } 
      out.write("\n");
      out.write("\t\t\t\t\t</div>\r\n");
