...
/**
 * Servlet implementation class MessageRequestList2Servlet
 */
@WebServlet("/mrlist_m")
public class MessageRequestList2Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MessageRequestList2Servlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<MessageRequest> list = new MessageRequestService().selectMyAll2(user_id);
		...
		for(MessageRequest mr : list){
			...
			job.put("userName", new MessageRequestService().selectUserIdName(user_id, mr.getUser_id())); // 이름 
