...
/**
 * Servlet implementation class SurferEnrollServlet
 */
@WebServlet("/surferenroll")
public class SurferEnrollServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SurferEnrollServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			int result = new SurferPartnerService().insertSurfer(sp);
